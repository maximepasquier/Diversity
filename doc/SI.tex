...
\begin{figure}[h]
	...
	\caption[Positions des individus : 1000 mouvements, densité variable]{Exemple de distibrution des individus contaminés à l'itération $7$ dans des systèmes de densités diffétentes. Les $4$ simulations ont un espace de $200 \times 200$ mais le nombre d'individus varie de $10000$ à $20000$.}
\end{figure}
