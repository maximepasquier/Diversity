...
\centering
\captionsetup{justification=centering}
\includegraphics[scale=0.4]{Images/SIR_exemple.pdf}
\caption[Modèle mathématique SIR]{Modèle mathématique SIR construit par les équations différentielles ordinaires.}
\end{figure}
